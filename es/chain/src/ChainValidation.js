...
var chainValidation = {
    ...
    is_account_name_error: function is_account_name_error(value, allow_too_short) {
        var shortlen = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3;
        var maxlen = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 63;
        ...
        if(!((strTemp >= 'a' && strTemp <= 'z') || (strTemp >= 'A' && strTemp <= 'Z'))) {
            return suffix + "begin";
        }         
