...
Pure JavaScript Zos library for node.js and browsers. Can be used to construct, sign and broadcast transactions in JavaScript, and to easily obtain data from the blockchain via public apis.
...
[![npm version](https://img.shields.io/npm/v/zosjs.svg?style=flat-square)](https://www.npmjs.com/package/zosjs)
[![npm downloads](https://img.shields.io/npm/dm/zosjs.svg?style=flat-square)](https://www.npmjs.com/package/zosjs)
...
```
var {PrivateKey, key} = require("zosjs");
